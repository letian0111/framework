...
class ProtoIDs {
	...
	static init(): void {
		...
		protoIDs["game.ChangeSeatNtf"] = _ID_GAME + 49,

		protoIDs["game.PlayerTableOptReq"] = _ID_GAME + 50,
		protoIDs["game.PlayerTableOptRep"] = _ID_GAME + 51,
		protoIDs["game.PlayerTableOptNtf"] = _ID_GAME + 52,
