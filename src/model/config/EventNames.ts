...
class EventNames {
    ...
    public static PLAYER_DATA_COMPLETED: string = "PLAYER_DATA_COMPLETED";  //玩家信息添加完成
    ...
    public static UPDATE_MY_CLUB_REVIVW_MEMBERS_LIST: string = "UPDATE_MY_CLUB_REVIVW_MEMBERS_LIST";
    public static CLUB_SEARCH_MEMBER_LOCAL_SUCC: string = "CLUB_SEARCH_MEMBER_LOCAL_SUCC";
    public static CLUB_REVIEW_AGREE_SUCC: string = "CLUB_REVIEW_AGREE_SUCC";
    public static CLUB_REMARK_SUCC: string = "CLUB_REMARK_SUCC";
    public static CLUB_FORBID_GAME_SUCC: string = "CLUB_FORBID_GAME_SUCC";
    ...
    public static USER_BIND_SUCC: string = "USER_BIND_SUCC";
    public static USER_BIND_FAIL: string = "USER_BIND_FAIL";
    ...
    public static GAME_CHANGE_SEAT_NTF: string = 'game.ChangeSeatNtf';
    public static GAME_PLAYER_TABLE_OPT_REQ: string = 'game.PlayerTableOptReq';
    public static GAME_PLAYER_TABLE_OPT_REP: string = 'game.PlayerTableOptRep';
    public static GAME_PLAYER_TABLE_OPT_NTF: string = 'game.PlayerTableOptNtf';
