...
class AlertInGameCtrl extends AlertCtrl {
    ...
    public onShow(): void {
        ...
        if(this.smallLabelTip){
            this._ui._labelSmallTip.visible = true
             this._ui._labelSmallTip.text = this.smallLabelTip
        }
        else
        {
            this._ui._labelSmallTip.visible = false
        }
        
    }

    public setSmallWord(str:any):void{

        this.smallLabelTip = str
    }
     public hide(): void {
        super.hide()
        this.smallLabelTip = null
    }
}