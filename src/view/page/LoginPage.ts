...
class LoginPage extends AppPage {
    constructor() {
        ...
        this._loadDatas = this._loadDatas.concat([
            { url: ResourceConfig.BG_LOGIN, type: Laya.Loader.IMAGE },
    ...
    protected init(...params): void {
        ...
        if (!this._loginUi) {
            ...
            this._loginUi._bg.skin = GameConfig.getLoginBg()
            ...
            let install =  NativeHelper.instance.getWXisInstall()
           
            // if(_OS == OSConfig.IOS_NATIVE_STORE && !install){
            ...
            //     GameConfig.IS_IOS_EXAMINE = false
            // }
           
            // log("xxxxxxxx"+GameConfig.IS_IOS_EXAMINE)
