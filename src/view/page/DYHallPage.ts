...
class DYHallPage extends AppPage {
    ...
    constructor() {
        ...
        this._loadDatas = this._loadDatas.concat([
            ...
            { url: ResourceConfig.SHEET_DAYE_HALL, type: Laya.Loader.ATLAS }, 
            { url: ResourceConfig.SHEET_CREATEROOM, type: Laya.Loader.ATLAS },
            { url: ResourceConfig.BG_DY_HALL, type: Laya.Loader.IMAGE }, 
        ...
        AppPage.register(DYHallPage, this._loadDatas);
        this.name = "DYHallPage";
    ...
    private onTouch(e: Laya.Event) {
        switch (e.currentTarget) {
            ...
            case this._menuUi._btnNotice:
                //绑定
                log("通知");
                log(GameConfig.language.daye_notice.length)
                AlertInGameSmallCtrl.instance.show(GameConfig.language.daye_notice, null, 0, false)
                break;
        }
