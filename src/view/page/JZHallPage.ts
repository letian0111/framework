...
class JZHallPage extends AppPage {

    constructor() {
        super();

        this._loadDatas = this._loadDatas.concat([{ url: ResourceConfig.SHEET_JUEZHAN, type: Laya.Loader.ATLAS }, { url: ResourceConfig.SHEET_HALL, type: Laya.Loader.ATLAS }, { url: ResourceConfig.SHEET_CREATEROOM, type: Laya.Loader.ATLAS },
        { url: ResourceConfig.BG_JUEZHAN, type: Laya.Loader.IMAGE }, { url: ResourceConfig.BOTTOM_JUEZHAN, type: Laya.Loader.IMAGE }, { url: ResourceConfig.SHEET_TONGYONG, type: Laya.Loader.ATLAS }
        ...
        AppPage.register(JZHallPage, this._loadDatas);
        this.name = "JZHallPage";
    ...
    protected init(...params): void {
        ...
        if (!this._menuUi) {
            ...
            this._hallTopUI._btn_buydiamond.skin = "juezhanhall/sBtn_buyDiamond.png"
            this._hallTopUI._btn_exchange.skin = "juezhanhall/sBtn_exchangge.png"
            ...
            if (TimeUtils.isToday(parseInt(time))){
                ...
                this._menuUi._share.visible = true
            ...
            EventManager.instance.registerOnObject(this, this._menuUi._btnBindUser, Laya.Event.CLICK, this, this.onTouch);
            EventManager.instance.registerOnObject(this, this._menuUi._btnFuli, Laya.Event.CLICK, this, this.onTouch);
            EventManager.instance.registerOnObject(this, this._menuUi._btnClub, Laya.Event.CLICK, this, this.onTouch);
    ...
    protected initPaoMaDeng() {
        ...
        if (!this._paomadengLabel) {
            ...
            this._paomadengLabel.text = "决战游戏代理火爆招募中，详情请咨询官方微信客服：queyou8866"
    ...
    */
    ...
    private onTouch(e: Laya.Event) {
        switch (e.currentTarget) {
            /*****************************/
            //下方按钮
            case this._menuUi._btnFuli:
                webService.lotteryList(function(data){
                    LotteryCtrl.instance.show(data.result)
                })
                break
            ...
            case this._menuUi._btnActivity:
                ...
                SevenDayCtrl.instance.show()
                break;
            case this._menuUi._btnDui:
                ExchangeCtrl.instance.show()
                break;
            ...
            case this._menuUi._btnKefu:
                ...
                log("客服");
                KeFuCtrl.instance.show("本游戏仅供休闲娱乐使用，游戏中有任何问题请联系客服微信<br>微信号：queyou8866")
                break;
            ...
            case this._menuUi._btnRedBagMatch:
                ...
                AlertInGameCtrl.instance.show(GameConfig.language.common_tip_unopen, null, 0, false)
                break;
            case this._menuUi._btnBindUser:
    ...
    protected onShowTopBtns() {
        if(!GameConfig.IS_IOS_EXAMINE){
            ...
            this._menuUi._btnBindUser.visible = true
        }
    }
     ...
     protected onHideTopBtns() {
         //if(!GameConfig.IS_IOS_EXAMINE){
            ...
            this._menuUi._btnBindUser.visible = false
         //}
    }
}