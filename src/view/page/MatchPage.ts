class MatchPage extends TablePage {
    ...
    protected init(...params): void {
        BaseGameData.tablelayout = this.getTableLayout()
    ...
    protected showJinji(){
        ...
        for(var k in BaseGameData.matchInfo.matchSwissPlayer){
            let v = BaseGameData.matchInfo.matchSwissPlayer[k]
            let res = "res/match/swiss_2.png"
            let fontSize = 24
            let fontcolor = "#beb2ab"
            if (v >= BaseGameData.matchInfo.matchSwissPlayer[BaseGameData.matchInfo.matchRounds-1 || 0] ){
                res = "res/match/swiss_1.png"
                fontcolor = "#820400" 
            }
            let view = new laya.ui.Image(res)
            let label = new laya.ui.Label(v)
            let line = new laya.ui.Image("match/lianjiexian.png")
            view.addChild(label)
    ...
    protected showMatchStart() {
        ...
        let res = "matchSign/ani/matchrstart.png"
