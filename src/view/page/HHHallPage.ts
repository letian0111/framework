...
class HHHallPage extends AppPage {
    ...
    constructor() {
        ...
        this._loadDatas = this._loadDatas.concat([
            ...
            { url: ResourceConfig.BG_HH_HALL, type: Laya.Loader.IMAGE }, 
        ...
        AppPage.register(HHHallPage, this._loadDatas);
        this.name = "HHHallPage";
