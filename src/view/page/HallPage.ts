...
class HallPage extends AppPage {

    constructor() {
        super();

        this._loadDatas = this._loadDatas.concat([{ url: ResourceConfig.SHEET_HALL, type: Laya.Loader.ATLAS }, { url: ResourceConfig.SHEET_CREATEROOM, type: Laya.Loader.ATLAS },
        ...
        AppPage.register(HallPage, this._loadDatas);
        this.name = "HallPage";
