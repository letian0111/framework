...
class LXHallPage extends AppPage {
    ...
    constructor() {
        ...
        this._loadDatas = this._loadDatas.concat([
            ...
            { url: ResourceConfig.SHEET_LX_HALL, type: Laya.Loader.ATLAS }, 
            { url: ResourceConfig.SHEET_CREATEROOM, type: Laya.Loader.ATLAS },
            { url: ResourceConfig.BG_LX_HALL, type: Laya.Loader.IMAGE }, 
        ...
        AppPage.register(LXHallPage, this._loadDatas);
        this.name = "LXHallPage";
    ...
    protected initPaoMaDeng() {
        ...
        if (!this._paomadengLabel) {
            ...
            this._paomadengLabel.text = "洪湖人都在玩的打板游戏，代理火爆招募中，详情请咨询官方微信客服："+GameConfig.KEFU
    ...
    private onTouch(e: Laya.Event) {
        switch (e.currentTarget) {
            ...
            case this._menuUi._btnRecord:
                ...
                this.showHistory();
                break;
            case this._menuUi._btnBxx:
                BxxCtrl.instance.show();
                break;
            ...
            case this._menuUi._btnNotice:
                //绑定
                log("通知");
                AlertInGameSmallCtrl.instance.show(GameConfig.language.honghu_notice, null, 0, false)
                break;
        }
