...
class LayaAir3D {
    ...
    private onLoadUrlConfigComplete(): void {
        GameConfig.getCfg(this.preLoad.bind(this));
    }
    ...
    */
    ...
    private init(): void {
        ...
        Native.instance.iapSetVerifyUrl(GameConfig.WEB_SERVICE_URL + "agent/public/notify/result?cid=" + GameConfig.CID + "&channel=" + GameConfig.CHANNEL)
        //cid=1&channel=tongjiang");
    }
    ...
    */
    private ctrlRegister(): void {
        ...
        { url: ResourceConfig.BITMAP_FONT_JOINTABLE1_JSON, type: Laya.Loader.JSON }, { url: ResourceConfig.BITMAP_FONT_JOINTABLE1_PNG, type: Laya.Loader.IMAGE },
        { url: ResourceConfig.BITMAP_FONT_JOINTABLE2_JSON, type: Laya.Loader.JSON }, { url: ResourceConfig.BITMAP_FONT_JOINTABLE2_PNG, type: Laya.Loader.IMAGE }]);
        ExchangeCtrl.instance.start([{ url: ResourceConfig.SHEET_DIALOG, type: Laya.Loader.ATLAS }, { url: ResourceConfig.SHEET_EXCHANGE, type: Laya.Loader.ATLAS }]);
        ExchangeListCtrl.instance.start([{ url: ResourceConfig.BG_EXCHANGE, type: Laya.Loader.IMAGE }, { url: ResourceConfig.LINE_EXCHANGE, type: Laya.Loader.IMAGE }]);
        BindPhoneCtrl.instance.start([{ url: ResourceConfig.SHEET_BIND_PHONE, type: Laya.Loader.ATLAS }])
        LotteryCtrl.instance.start([{ url: ResourceConfig.SHEET_DIALOG, type: Laya.Loader.ATLAS }, { url: ResourceConfig.SHEET_LOTTERY, type: Laya.Loader.ATLAS }, { url: ResourceConfig.WHEEL, type: Laya.Loader.IMAGE }])
        BindInviteCtrl.instance.start([{ url: ResourceConfig.SHEET_DIALOG, type: Laya.Loader.ATLAS },{ url: ResourceConfig.SHEET_EXCHANGE, type: Laya.Loader.ATLAS },{ url: ResourceConfig.SHEET_BIND_PHONE, type: Laya.Loader.ATLAS }])
        ShareDailyCtrl.instance.start([{ url: ResourceConfig.SHEET_DIALOG, type: Laya.Loader.ATLAS },{url: ResourceConfig.SHEET_SHARE, type: Laya.Loader.ATLAS},{ url: ResourceConfig.SHARE, type: Laya.Loader.IMAGE }])
        SevenDayCtrl.instance.start([{ url: ResourceConfig.SHEET_DIALOG, type: Laya.Loader.ATLAS },{ url: ResourceConfig.SHEET_EXCHANGE, type: Laya.Loader.ATLAS },
                                    { url: ResourceConfig.SHEET_ACTIVITY, type: Laya.Loader.ATLAS },{ url: ResourceConfig.SHEET_LOTTERY, type: Laya.Loader.ATLAS }])
        ...
        Laya.loader.load([{ url: ResourceConfig.SHEET_TONGYONG, type: Laya.Loader.ATLAS }, { url: ResourceConfig.SHEET_GAME_NAME, type: Laya.Loader.ATLAS },
